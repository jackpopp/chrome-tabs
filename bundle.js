...
var Tab = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                'span',
                { className: 'pull-right close-button', onClick: this.close },
                'x'
            ),
            ' ',
            React.createElement(
                'span',
                { className: 'tab-title', onClick: this['switch'] },
                this.props.title
            )
        );
    }
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'panel-heading', onClick: this.toggleOpen },
                    React.createElement(
                        'span',
    ...
    getData: function getData(tab) {
        ...
        ws.fetch(function (windows) {
            ...
            ts.fetch(function (tabs) {
                ...
                _this3.setState({ windows: windows });
            });
        });
    },
...
},{"./tabService.js":159,"./utils.js":160,"./windowDataBuilder.js":161,"./windowService.js":162,"react":156,"sweetalert":157}],159:[function(require,module,exports){
'use strict';
